  ...
  return (
    ...
    {noTasks ? 
      <div className='grid grid-cols-1 gap-6 '>
             <div>
                <h1 className='font-bold text-2xl mt-48 text-indigo-500 underline'>Tasks In Process</h1>
             </div>
        {inProcessTasks.map((t) => ( 
            ...
            <p className='font-bold text-2xl mt-48 text-indigo-500'>{backMsg}</p>
...
const InProcess = () => {
  ...
  return (
    ...
    {noTasks ? 
      <div className='grid grid-cols-1 gap-6 '>
             <div>
                <h1 className='font-bold'>Tasks In Process</h1>
             </div>
        {inProcessTasks.map((t) => ( 
            <div className="card card-compact w-96 bg-base-100 shadow-xl mt-6">
            <div className="card-body">
